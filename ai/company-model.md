...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "METRO") |
| group        | string   | Parent company group (e.g. "METRO AG") |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/peviitor-scrapers/metro-cash-carry-romania-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)
