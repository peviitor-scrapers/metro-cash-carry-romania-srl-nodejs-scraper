...
```bash
gh issue list --repo peviitor-scrapers/metro-cash-carry-romania-srl-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "METRO", not the old template
